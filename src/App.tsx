...
function Layout() {
  ...
  const routes = [
    ...
    { path: "/projetos/:slug", element: <ProjetoDetalhe />, meta: { hasCarousel: false } },
    { path: "/premiacoes", element: <Premiacoes />, meta: { hasCarousel: false } },
  ...
  return (
    <div className="flex min-h-screen">
      {!hasCarousel && <Sidebar isOpen={sidebarOpen} toggleOpen={toggleSidebar} />}
      <div
